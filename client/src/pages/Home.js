		...
		<Box>
			...
			<Grid container spacing={2} px={{xs: 4, lg: 12, xl: 16}} py={{xs: 4, lg: 8}}>
				<Grid item md={7}>
					...
					<Typography variant='h2' py={{ xs: 2 }}>Come to our 2024 Spring Show, Resurgence, on May 3 and 4 at 7 PM in the RISD Auditorium. Grab your tickets <Link color={'#ffffff'} href="https://payment.brown.edu/C20460_ustores/web/product_detail.jsp?PRODUCTID=5295">here</Link>.</Typography>
				</Grid>
				<Grid item md={5}>
