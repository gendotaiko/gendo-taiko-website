...
const Home = () => {
	return (
		<Box>
			<Image src={process.env.PUBLIC_URL + '/images/cover.jpg'} />
			<Grid container spacing={2} px={{xs: 4, lg: 12, xl: 16}} py={{xs: 4, lg: 8}}>
				...
				<Grid item md={5}>
					<Image src={'/images/taiko2019_promo_15.jpg'} />
				</Grid>
			</Grid>
			...
			<Grid container spacing={{xs: 8, lg: 12}} px={{xs: 4, lg: 12, xl: 16}} py={{xs: 4, lg: 8}}>
				<Grid item md={6}>
					...
					<Image src={'/images/taiko2019_promo_11.jpg'} />
				</Grid>
				<Grid item md={6}>
					...
					<Image src={'/images/taiko2019_promo_2.jpg'} />
					...
					<Image src={'/images/taiko2019_promo_7.jpg'} />
				</Grid>
			</Grid>
		</Box>
	);
